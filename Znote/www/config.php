<?php
	...
	*/
	...
	$config['available_towns'] = array(1, 3, 9);
	...
	$config['house'] = array(
			'house_file' => 'D:\GitHub\kylskapapp\data\world\world-house.xml',
			'price_sqm' => '250', // price per house sqm
		);
	...
	$config['client'] = 740; // 954 = tibia 9.54
	...
	*/
	...
	$config['paypal'] = array(
		'enabled' => true,
		'email' => 'oliver.bjorklund@bahnhof.se', // Example: paypal@mail.com
		'currency' => 'EUR',
	...
	$config['paygol'] = array(
		'enabled' => true,
		'serviceID' => 361334,// Service ID from paygol.com
		'currency' => 'EUR',
		'price' => 5,
