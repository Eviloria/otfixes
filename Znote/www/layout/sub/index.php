<h2><strong><span style="color: #91ca3d;">Last Updates!</span></strong></h2>
...
if ($config['UseChangelogTicker']) {
	...
	if (isset($changelogs) && !empty($changelogs) && $changelogs !== false) {
		...
		<table id="changelogTable">
			<tr class="yellow">
			</div>					<h2 class="intro-text">Latest News</h2>
					<div class="9000news" style="text-align:justify;">
					<hr width="98%">
					<h4><strong><span style="color: #91ca3d;">Updates!</span></strong></h4>
